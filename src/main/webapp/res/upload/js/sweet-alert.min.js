...
function(e, t) {
	...
	function o(t) {
		...
		if (o.innerHTML = b(t.title).split("\n").join("<br>"), r.innerHTML = b(t.text || "").split("\n").join("<br>"), t.text && w(r), x(n.querySelectorAll(".icon")), t.type) {
			...
			case "success":
				g(u, "animate"),
				g(u.querySelector(".short"), "animateSuccessTip"),
	...
	function l() {
		...
		v(o, "animate"),
		v(o.querySelector(".short"), "animateSuccessTip"),
...
} (window, document); //素材家园 - www.sucaijiayuan.com
